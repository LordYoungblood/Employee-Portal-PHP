    ...
    <div class="card card-body bg-light mt-5">
      ...
      <form action="<?php echo URLROOT; ?>/users/register" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" name="salary" class="form-control form-control-lg <?php echo (!empty($data['salary_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['salary']; ?>">
          <span class="invalid-feedback"><?php echo $data['salary_err']; ?></span>
        </div>
        <div class="form-group">
          <label for="SSN">SSN: <sup>*</sup></label>
          <input type="text" name="SSN" class="form-control form-control-lg <?php echo (!empty($data['SSN_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['SSN']; ?>">
